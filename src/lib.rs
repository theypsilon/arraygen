...
/// 
/// The only thing you need to care is that the type returned by `your_method_name` is compatible with the type of the field with the `in_array` attribute.
...
/// 
/// #[derive(Arraygen)]
/// #[gen_array(fn get_options: &mut dyn SetNone)]
/// struct ManyOptions {
///     #[in_array(get_options)]
///     a: Option<i32>,
///     #[in_array(get_options)]
///     b: Option<String>,
///     c: Option<String>,
...
/// };
/// 
/// many.get_options().iter_mut().for_each(|option| option.set_none());
/// 
